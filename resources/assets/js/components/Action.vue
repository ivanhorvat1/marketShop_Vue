                ...
                <div class="row">
                    ...
                    <div class="wrap">
                        <div style="height: 450px;" class="box one" v-if="articles.length > 0"
                            ...
                            <section v-if="articlea.toDate" class="promotionDate">
                                <div class="row">
                                    <div class="col-md-1">
                                        <div id="header">
                                            <p class="verticaltext">
                                                Promocija <br> traje do: <b>{{ articlea.toDate }}</b>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    <div class="row">
                        ...
                        <div class="modal-content col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-6"
                                     v-b-tooltip.hover.html="'<h6>Promocija traje do: '+toDateMaxi+'</h6>'">
                                    <img style="height: 55px; width: 80px"
                                         src="images/market_logo/delhaize-maxi-logo-vector.png"/>
                                    <h5>
                                        <del>{{maxiOldPrice}}</del>
                                    </h5>
                                    <h5><b>{{maxiCena}}{{' '+supplementaryPriceMaxi2}}</b></h5>
                                    <h5><b>{{supplementaryPriceMaxi}}</b></h5><br>
                                </div>
                                <div class="col-sm-6"
                                     v-b-tooltip.hover.html="'<h6>Promocija traje do: '+toDateIdea+'</h6>'">
                                    <img style="height: 50px; width: 80px"
                                         src="images/market_logo/Idea_Logo_resized.png"/>
                                    <h5>
                                        <del>{{ideaOldPrice}}</del>
                                    </h5>
                                    <h5><b>{{ideaCena}}</b></h5>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <h5>
                                        <del>{{univerexportOldPrice}}</del>
                                    </h5>
                                    <h5><b>{{univerexportCena}}</b></h5>
                                    <h5><b>{{supplementaryPriceUniver2}}</b></h5>
                                </div>
                            </div>
                        </div>
                    </div>
