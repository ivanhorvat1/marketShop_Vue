...
<div class="stars">
    <div class="custom-navbar">
        <div class="brand-logo">
            <img src="images/Logo6_white.png" width="130px">
        </div>
    ...
    <div class="central-body">
        <img class="image-404" src="images/404_error/404.svg" width="300px">
...
<style>
    ...
    .bg-purple{
        background: url("images/404_error/bg_purple.png");
    ...
    .stars{
        background: url("images/404_error/overlay_stars.svg");
