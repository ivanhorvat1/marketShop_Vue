...
class CreateUniverexportDrinksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('univerexport_drinks', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('code');
    ...
    {
        Schema::dropIfExists('univerexport_drinks');
    }
}
