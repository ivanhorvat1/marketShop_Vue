...
class CreateUniverexportFreezeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('univerexport_freeze', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('code');
    ...
    {
        Schema::dropIfExists('univerexport_freeze');
    }
}
